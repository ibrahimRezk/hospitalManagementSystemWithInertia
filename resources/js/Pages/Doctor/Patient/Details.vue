...
<div  class=" mt-2" v-show="tab === 2" v-for="patient_record in patient_records " :key="patient_record.id">
        ...
        <div class="relative wrap overflow-hidden p-10 h-full">
          ...
          <div class="mb-8 flex justify-between items-center w-full">
            ...
            <div class="order-1 bg-gray-300 rounded-lg shadow-xl w-5/12 px-6 py-4">
              ...
              <p class="text-base leading-snug tracking-wide text-gray-900 text-opacity-100">Diagnosis : {{ patient_record.diagnose }}</p>

              <p class="text-base leading-snug tracking-wide text-gray-900 text-opacity-100">Medicine : {{ patient_record.medicine }}</p>

              <p class="text-base leading-snug tracking-wide text-gray-900 text-opacity-100">Doctor Name : {{ patient_record.doctor.name }}</p>
            </div>
          </div>
...
<div  class=" mt-2" v-show="tab === 3">
    <Table :headers="patientRadiologiesHeaders" :items="patient_radiologies">
...
<!-- ///////////////////////////////////////////////////////////////////////////////// -->
                    <div  class=" mt-2" v-show="tab === 4">
                        <Table :headers="patientLaboratoriesHeaders" :items="patient_laboratories">
                            <template v-slot="{ item }">
