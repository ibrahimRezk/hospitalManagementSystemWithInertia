...
const submit = () => {
    props.edit
        ...
        : form.post(route(`laboratorist.${props.routeResourceName}.store`));
};
</script>
    ...
    <Layout>
        ...
        <Container>
            <Card>
                <div>
                    <label
                        class="mb-3 mx-4 bg-blue-200 px-5 rounded-lg shadow-md"
                ...
                <div>
                    <label
                        class="mt-1 mx-4 bg-green-200 px-5 rounded-lg shadow-md"
                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-1 gap-6 mt-5">
                        <div>
                            <label
                                class="mb-2 mx-4 bg-red-200 px-5 rounded-lg shadow-md"
                            ...
                            <div>
                                ...
                                <div class="col-span-2">
                                    <ImageUpload
                                        :item = "props.item"
                                        model-type="App\Models\Laboratory"
                                        :model-id="item.id"
