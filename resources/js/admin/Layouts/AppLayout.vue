...
import JetApplicationMark from '@/admin/Components/ApplicationMark.vue';
import JetBanner from '@/admin/Components/Banner.vue';
import JetDropdown from '@/admin/Components/Dropdown.vue';
import JetDropdownLink from '@/admin/Components/DropdownLink.vue';
import JetNavLink from '@/admin/Components/NavLink.vue';
import JetResponsiveNavLink from '@/admin/Components/ResponsiveNavLink.vue';
            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('admin.dashboard')" :active="route().current('dashboard')">
                            Dashboard
